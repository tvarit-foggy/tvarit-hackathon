...
public class BasicStreamingJob {
    ...
    private static final String inputStreamName = "Hackathon-12-09-2020-Team-B-Source";
    private static final String outputStreamName = "Hackathon-12-09-2020-Team-B-Target";
